...
import { TrendingUp, TrendingDown, ChevronDown, BarChart3, Newspaper, Sparkles } from 'lucide-react';
      ...
      <section className="landing-section relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="inline-flex items-center gap-3 bg-primary px-6 py-3 rounded-full mb-6">
