...
export function NewsSection({ selectedSymbol, selectedMarket }: NewsSectionProps = {}) {
  ...
  const getSentimentBadge = (sentiment: string) => {
    switch (sentiment) {
      case 'positive':
        return <Badge variant="outline" className="border-green-500 text-green-700 bg-green-50 text-xs font-semibold">긍정</Badge>;
      case 'negative':
        return <Badge variant="outline" className="border-red-500 text-red-700 bg-red-50 text-xs font-semibold">부정</Badge>;
      default:
        return <Badge variant="outline" className="border-gray-400 text-gray-600 bg-gray-50 text-xs font-semibold">중립</Badge>;
    }
  };
