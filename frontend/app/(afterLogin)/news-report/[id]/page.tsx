      ...
      const newsData = [
        {
          ...
          source: 'AI Analysis',
          published_date: reportData.generatedAt,
          ...
          content: `
## 감성 분석
- 긍정: ${reportData.sentimentDistribution.positive}개
- 중립: ${reportData.sentimentDistribution.neutral}개
- 부정: ${reportData.sentimentDistribution.negative}개
...
## 투자 권고
추천: ${reportData.investmentRecommendation.recommendation}
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 md:grid-cols-4">
              <div className="text-center p-3 sm:p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-2xl sm:text-3xl md:text-2xl font-bold">{reportData.analyzedCount}</p>
              </div>
